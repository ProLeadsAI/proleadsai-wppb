 ...
 *
 * @package    Proleadsai
 * @subpackage Proleadsai/includes
 */
...
class Proleadsai {
	 ...
	 * @since    1.0.0
	 * @access   protected
	 * @var      Proleadsai_Loader    $loader    Maintains and registers all hooks for the plugin.
	 */
	protected $loader;
	...
	public function __construct() {
		if ( defined( 'PROLEADSAI_VERSION' ) ) {
			$this->version = PROLEADSAI_VERSION;
		} else {
			$this->version = '1.0.0';
		}
	...
	private function load_dependencies() {
		 ...
		 * side of the site.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'public/class-proleadsai-public.php';
	...
	private function define_admin_hooks() {
		...
		$plugin_admin = new Proleadsai_Admin( $this->get_plugin_name(), $this->get_version() );

		$this->loader->add_action( 'admin_enqueue_scripts', $plugin_admin, 'enqueue_styles' );
		$this->loader->add_action( 'admin_enqueue_scripts', $plugin_admin, 'enqueue_scripts' );
		$this->loader->add_action( 'admin_menu', $plugin_admin, 'add_admin_menu' );
		$this->loader->add_filter( 'script_loader_tag', $plugin_admin, 'add_module_type_attribute', 10, 3 );
	...
	private function define_public_hooks() {
		...
		$plugin_public = new Proleadsai_Public( $this->get_plugin_name(), $this->get_version() );
	 ...
	 *
	 * @since     1.0.0
	 * @return    Proleadsai_Loader    Orchestrates the hooks of the plugin.
	 */
